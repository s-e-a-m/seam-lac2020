...
\begin{description}
  \item[seam.lib] contains general functions and the pointers to the separates specific libraries. It may contain the custom performative environment definition, as for the inputs, the controls and outs.
  \item[gerzon.lib] contains early Michael Gerzon works, his core concepts of spatialization and stereophony that conducted him to conceive ambisonic technology. 
  \item[hardware.lib] contains hardware-related functions like I/O assignations to audio interface, with a routing strategy to connect instruments to real-world hardware and MIDI mapping.
  ...
  \item[nono.lib] is the first author-related library that points to contain Live Electronics Instruments used by Nono. The idea is to collect instruments into the library and use it, work by work, in a hardware-like view. 
\end{description}
